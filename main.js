...
// associated university of index.html

        // Remove the JavaScript code provided earlier
        ...
        // Additional code to handle image hover events

        const sliderImages = document.querySelectorAll('.slider img');

        sliderImages.forEach((image) => {
            image.addEventListener('mouseenter', pauseSlider);
            image.addEventListener('mouseleave', resumeSlider);
        });
